/**
 * SVG icons (Lucide / stroke style) — tyIcon(name, size?, class?)
 * + tyHydrateIcons(root?) for [data-ty-icon]
 */
(function (g) {
  const P = {
  ...
  /** Update a single node after a data-ty-icon change (querySelector does not include the root element). */
